...
type CreateUserRequest struct {
	...
	Introduce string `thrift:"introduce,4" form:"introduce" json:"introduce" vd:"(len($) > 0 && len($) < 1024)"`
}
...
type QueryUserRequest struct {
	...
	Page     int64   `thrift:"Page,2" form:"page" json:"page" query:"page" vd:"($ > 0 && $ < 1000000000)"`
	PageSize int64   `thrift:"PageSize,3" form:"page_size" form:"page_size" json:"page_size" query:"page_size" vd:"($ > 0 || $ <= 100)"`
}
...
type UpdateUserRequest struct {
	...
	Introduce string `thrift:"introduce,5" form:"introduce" json:"introduce" vd:"(len($) > 0 && len($) < 1024)"`
}
