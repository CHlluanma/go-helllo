...
type Message struct {
	...
	CreateTime int64  `protobuf:"varint,5,opt,name=create_time,json=createTime,proto3" form:"create_time" json:"create_time,omitempty" query:"create_time"`
}
...
type DouyinMessageChatRequest struct {
	...
	ToUserId   int64  `protobuf:"varint,2,opt,name=to_user_id,json=toUserId,proto3" form:"to_user_id" json:"to_user_id,omitempty" query:"to_user_id"` // 对方用户id
	PreMsgTime int64  `protobuf:"varint,3,opt,name=pre_msg_time,json=preMsgTime,proto3" form:"pre_msg_time" json:"pre_msg_time,omitempty" query:"pre_msg_time"`
}
...
type DouyinMessageChatResponse struct {
	...
	MessageList []*Message `protobuf:"bytes,3,rep,name=message_list,json=messageList,proto3" form:"message_list" json:"message_list,omitempty" query:"message_list"`
}
...
type DouyinMessageActionRequest struct {
	...
	Token      string `protobuf:"bytes,1,opt,name=token,proto3" form:"token" json:"token,omitempty" query:"token"`
	ToUserId   int64  `protobuf:"varint,2,opt,name=to_user_id,json=toUserId,proto3" form:"to_user_id" json:"to_user_id,omitempty" query:"to_user_id"`
	ActionType int32  `protobuf:"varint,3,opt,name=action_type,json=actionType,proto3" form:"action_type" json:"action_type,omitempty" query:"action_type"`
	Content    string `protobuf:"bytes,4,opt,name=content,proto3" form:"content" json:"content,omitempty" query:"content"`
}
...
var file_message_proto_rawDesc = []byte{
	...
	0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x22, 0x70, 0x0a, 0x18, 0x44, 0x6f,
	...
	0x52, 0x0a, 0x70, 0x72, 0x65, 0x4d, 0x73, 0x67, 0x54, 0x69, 0x6d, 0x65, 0x22, 0xa8, 0x01, 0x0a,
	0x19, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x43, 0x68,
	0x61, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x37, 0x0a, 0x0b, 0x73, 0x74,
	0x61, 0x74, 0x75, 0x73, 0x5f, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x42,
	0x16, 0xea, 0xbb, 0x18, 0x12, 0x6a, 0x73, 0x6f, 0x6e, 0x3a, 0x22, 0x73, 0x74, 0x61, 0x74, 0x75,
	...
	0x73, 0x67, 0x12, 0x33, 0x0a, 0x0c, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x5f, 0x6c, 0x69,
	0x73, 0x74, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x6d, 0x65, 0x73, 0x73, 0x61,
	0x67, 0x65, 0x2e, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x52, 0x0b, 0x6d, 0x65, 0x73, 0x73,
	0x61, 0x67, 0x65, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x8b, 0x01, 0x0a, 0x1a, 0x44, 0x6f, 0x75, 0x79,
	...
	0x6f, 0x64, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x42, 0x16, 0xea, 0xbb, 0x18, 0x12, 0x6a,
	...
	0x65, 0x2f, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x2f, 0x42, 0x5a, 0x5a, 0x58, 0x67, 0x69, 0x74,
	0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x61, 0x68, 0x61, 0x6e, 0x67, 0x37, 0x2f, 0x67,
	0x6f, 0x2d, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x2f, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x77, 0x65, 0x67,
	0x6f, 0x2f, 0x68, 0x65, 0x72, 0x74, 0x7a, 0x2f, 0x62, 0x69, 0x7a, 0x5f, 0x64, 0x65, 0x6d, 0x6f,
	0x2f, 0x74, 0x69, 0x6b, 0x74, 0x6f, 0x6b, 0x5f, 0x64, 0x65, 0x6d, 0x6f, 0x2f, 0x62, 0x69, 0x7a,
	0x2f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x2f, 0x73, 0x6f, 0x63, 0x69, 0x61, 0x6c, 0x2f, 0x6d, 0x65,
...
var file_message_proto_goTypes = []interface{}{
	...
	(*DouyinMessageChatRequest)(nil),    // 1: message.DouyinMessageChatRequest
	(*DouyinMessageChatResponse)(nil),   // 2: message.DouyinMessageChatResponse
...
var file_message_proto_depIdxs = []int32{
	0, // 0: message.DouyinMessageChatResponse.message_list:type_name -> message.Message
	1, // 1: message.MessageService.MessageChat:input_type -> message.DouyinMessageChatRequest
	3, // 2: message.MessageService.MessageAction:input_type -> message.DouyinMessageActionRequest
	2, // 3: message.MessageService.MessageChat:output_type -> message.DouyinMessageChatResponse
	4, // 4: message.MessageService.MessageAction:output_type -> message.DouyinMessageActionResponse
