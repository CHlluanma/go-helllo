...
import (
	...
	common "github.com/chhz0/go-hello/cloudwego/hertz/biz_demo/tiktok_demo/biz/model/common"
...
type DouyinRelationActionRequest struct {
	...
	ToUserId   int64  `protobuf:"varint,2,opt,name=to_user_id,json=toUserId,proto3" form:"to_user_id" json:"to_user_id,omitempty" query:"to_user_id"`
	ActionType int32  `protobuf:"varint,3,opt,name=action_type,json=actionType,proto3" form:"action_type" json:"action_type,omitempty" query:"action_type"` // 1-关注，2-取消关注
}
...
type DouyinRelationFollowListResponse struct {
	...
	StatusCode int32          `protobuf:"varint,1,opt,name=status_code,json=statusCode,proto3" form:"status_code" json:"status_code,omitempty" query:"status_code"`
	StatusMsg  string         `protobuf:"bytes,2,opt,name=status_msg,json=statusMsg,proto3" form:"status_msg" json:"status_msg,omitempty" query:"status_msg"`
	UserList   []*common.User `protobuf:"bytes,3,rep,name=user_list,json=userList,proto3" form:"user_list" json:"user_list,omitempty" query:"user_list"`
}
...
type DouyinRelationFriendListResponse struct {
	...
	StatusCode int32         `protobuf:"varint,1,opt,name=status_code,json=statusCode,proto3" form:"status_code" json:"status_code,omitempty" query:"status_code"`
	StatusMsg  string        `protobuf:"bytes,2,opt,name=status_msg,json=statusMsg,proto3" form:"status_msg" json:"status_msg,omitempty" query:"status_msg"`
	FriendList []*FriendUser `protobuf:"bytes,3,rep,name=friend_list,json=friendList,proto3" form:"friend_list" json:"friend_list,omitempty" query:"friend_list"`
}
...
func (x *DouyinRelationFriendListResponse) GetFriendList() []*FriendUser {
	if x != nil {
		return x.FriendList
	}
	return nil
...
type FriendUser struct {
	...
	MsgType int64  `protobuf:"varint,3,opt,name=msg_type,json=msgType,proto3" form:"msg_type" json:"msg_type,omitempty" query:"msg_type"` // message type，0 - Messages currently requested by the user，1 - Messages sent by the current requesting user
}
...
type FriendUser_User struct {
	...
	User *FriendUser_User `protobuf:"bytes,1,opt,name=user,proto3" form:"user" json:"user,omitempty" query:"user"`
}
...
var file_relation_proto_rawDesc = []byte{
	...
	0x73, 0x5f, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x42, 0x16, 0xea, 0xbb,
	...
	0x5f, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x42, 0x16, 0xea, 0xbb, 0x18,
	...
	0x28, 0x05, 0x42, 0x16, 0xea, 0xbb, 0x18, 0x12, 0x6a, 0x73, 0x6f, 0x6e, 0x3a, 0x22, 0x73, 0x74,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0xb1, 0x01, 0x0a, 0x20,
	...
	0x01, 0x20, 0x01, 0x28, 0x05, 0x42, 0x16, 0xea, 0xbb, 0x18, 0x12, 0x6a, 0x73, 0x6f, 0x6e, 0x3a,
	...
	,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x2f, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x2f, 0x12, 0x8e, 0x01, 0x0a,
	0x12, 0x52, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x46, 0x6f, 0x6c, 0x6c, 0x6f, 0x77, 0x4c,
	0x69, 0x73, 0x74, 0x12, 0x29, 0x2e, 0x72, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x44,
	0x6f, 0x75, 0x79, 0x69, 0x6e, 0x52, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x46, 0x6f, 0x6c,
	0x6c, 0x6f, 0x77, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x2a,
	...
	0x2f, 0x66, 0x6f, 0x6c, 0x6c, 0x6f, 0x77, 0x2f, 0x6c, 0x69, 0x73, 0x74, 0x2f, 0x12, 0x96, 0x01,
	0x0a, 0x14, 0x52, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x46, 0x6f, 0x6c, 0x6c, 0x6f, 0x77,
	0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x2b, 0x2e, 0x72, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x2e, 0x44, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x52, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	0x46, 0x6f, 0x6c, 0x6c, 0x6f, 0x77, 0x65, 0x72, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x1a, 0x2c, 0x2e, 0x72, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x44,
	0x6f, 0x75, 0x79, 0x69, 0x6e, 0x52, 0x65, 0x6c, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x46, 0x6f, 0x6c,
	...
	0x2f, 0x6c, 0x69, 0x73, 0x74, 0x2f, 0x12, 0x92, 0x01, 0x0a, 0x12, 0x52, 0x65, 0x6c, 0x61, 0x74,
	0x69, 0x6f, 0x6e, 0x46, 0x72, 0x69, 0x65, 0x6e, 0x64, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x2b, 0x2e,
	...
	,
...
var file_relation_proto_depIdxs = []int32{
	...
	8,  // 2: relation.DouyinRelationFriendListResponse.friend_list:type_name -> relation.FriendUser
	9,  // 3: relation.FriendUser.User.user:type_name -> relation.FriendUser.User
	0,  // 4: relation.RelationService.RelationAction:input_type -> relation.DouyinRelationActionRequest
	2,  // 5: relation.RelationService.RelationFollowList:input_type -> relation.DouyinRelationFollowListRequest
	4,  // 6: relation.RelationService.RelationFollowerList:input_type -> relation.DouyinRelationFollowerListRequest
	4,  // 7: relation.RelationService.RelationFriendList:input_type -> relation.DouyinRelationFollowerListRequest
	1,  // 8: relation.RelationService.RelationAction:output_type -> relation.DouyinRelationActionResponse
	3,  // 9: relation.RelationService.RelationFollowList:output_type -> relation.DouyinRelationFollowListResponse
	5,  // 10: relation.RelationService.RelationFollowerList:output_type -> relation.DouyinRelationFollowerListResponse
	5,  // 11: relation.RelationService.RelationFriendList:output_type -> relation.DouyinRelationFollowerListResponse
