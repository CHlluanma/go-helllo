...
type DouyinCommentActionRequest struct {
	...
	VideoId     int64  `protobuf:"varint,2,opt,name=video_id,json=videoId,proto3" form:"video_id" json:"video_id,omitempty" query:"video_id"`
	ActionType  int32  `protobuf:"varint,3,opt,name=action_type,json=actionType,proto3" form:"action_type" json:"action_type,omitempty" query:"action_type"` // 1-发布评论，2-删除评论
	CommentText string `protobuf:"bytes,4,opt,name=comment_text,json=commentText,proto3" form:"comment_text" json:"comment_text,omitempty" query:"comment_text"`
	CommentId   int64  `protobuf:"varint,5,opt,name=comment_id,json=commentId,proto3" form:"comment_id" json:"comment_id,omitempty" query:"comment_id"`
}
...
type DouyinCommentActionResponse struct {
	...
	Comment    *Comment `protobuf:"bytes,3,opt,name=comment,proto3" form:"comment" json:"comment,omitempty" query:"comment"`
}
...
type Comment struct {
	...
	User       *common.User `protobuf:"bytes,2,opt,name=user,proto3" form:"user" json:"user,omitempty" query:"user"`
	Content    string       `protobuf:"bytes,3,opt,name=content,proto3" form:"content" json:"content,omitempty" query:"content"`
	CreateDate string       `protobuf:"bytes,4,opt,name=create_date,json=createDate,proto3" form:"create_date" json:"create_date,omitempty" query:"create_date"`
}
...
type DouyinCommentListResponse struct {
	...
	StatusCode  int32      `protobuf:"varint,1,opt,name=status_code,json=statusCode,proto3" form:"status_code" json:"status_code,omitempty" query:"status_code"`
	StatusMsg   string     `protobuf:"bytes,2,opt,name=status_msg,json=statusMsg,proto3" form:"status_msg" json:"status_msg,omitempty" query:"status_msg"`
	CommentList []*Comment `protobuf:"bytes,3,rep,name=comment_list,json=commentList,proto3" form:"comment_list" json:"comment_list,omitempty" query:"comment_list"`
}
...
var file_comment_proto_rawDesc = []byte{
	...
	0x74, 0x32, 0xfa, 0x01, 0x0a, 0x0e, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x53, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x12, 0x77, 0x0a, 0x0d, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x41,
	...
	0x2f, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x2f, 0x6c, 0x69, 0x73, 0x74, 0x2f, 0x42, 0x5c,
	0x5a, 0x5a, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x61, 0x68, 0x61,
	0x6e, 0x67, 0x37, 0x2f, 0x67, 0x6f, 0x2d, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x2f, 0x63, 0x6c, 0x6f,
	0x75, 0x64, 0x77, 0x65, 0x67, 0x6f, 0x2f, 0x68, 0x65, 0x72, 0x74, 0x7a, 0x2f, 0x62, 0x69, 0x7a,
	0x5f, 0x64, 0x65, 0x6d, 0x6f, 0x2f, 0x74, 0x69, 0x6b, 0x74, 0x6f, 0x6b, 0x5f, 0x64, 0x65, 0x6d,
	0x6f, 0x2f, 0x62, 0x69, 0x7a, 0x2f, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x2f, 0x69, 0x6e, 0x74, 0x65,
