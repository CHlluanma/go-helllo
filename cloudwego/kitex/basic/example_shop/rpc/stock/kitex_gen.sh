...
# 最后一个参数则为该服务的 IDL 文件
# 
kitex -module github.com/CHlluanma/go-hello -service example.shop.item -use github.com/CHlluanma/go-hello/cloudwego/kitex/basic/example_shop/kitex_gen ../../idl/stock.thrift