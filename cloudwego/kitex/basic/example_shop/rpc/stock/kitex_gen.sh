...
# 最后一个参数则为该服务的 IDL 文件
# 
kitex -module github.com/ahang7/go-hello -service example.shop.item -use github.com/ahang7/go-hello/cloudwego/kitex/basic/example_shop/kitex_gen ../../idl/stock.thrift