...
type Hello interface {
	Echo(ctx context.Context, request *Request) (r *Response, err error)

	Add(ctx context.Context, request *AddRequest) (r *AddResponse, err error)
}
...
var HelloEchoArgs_Request_DEFAULT *Request

func (p *HelloEchoArgs) GetRequest() (v *Request) {
	if !p.IsSetRequest() {
		return HelloEchoArgs_Request_DEFAULT
	}
	return p.Request
}
func (p *HelloEchoArgs) SetRequest(val *Request) {
	p.Request = val
}
...
func (p *HelloEchoArgs) IsSetRequest() bool {
...
type HelloAddArgs struct {
	Request *AddRequest `thrift:"request,1" frugal:"1,default,AddRequest" json:"request"`
}
...
var HelloAddArgs_Request_DEFAULT *AddRequest

func (p *HelloAddArgs) GetRequest() (v *AddRequest) {
	if !p.IsSetRequest() {
		return HelloAddArgs_Request_DEFAULT
	}
	return p.Request
}
func (p *HelloAddArgs) SetRequest(val *AddRequest) {
	p.Request = val
}
...
func (p *HelloAddArgs) IsSetRequest() bool {
	return p.Request != nil
}
